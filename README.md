...
КонецЦикла;
```
В примере вызов TUI для наглядности делается дважды.

https://github.com/user-attachments/assets/702a9cec-cf1c-4b4a-ad98-738b479e141e
...
Основные элементы управления для интерфейса присутствуют. Планирую (как будет время и запросы) добавление новых классов. Пишите замечания и пожелания. Контакт указан на сайте по ссылке вверху.
