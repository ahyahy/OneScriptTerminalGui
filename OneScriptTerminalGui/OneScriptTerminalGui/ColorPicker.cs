...
namespace ostgui
{
    ...
    [ContextClass("ТфВыборЦвета", "TfColorPicker")]
    public class TfColorPicker : AutoContext<TfColorPicker>
    {
        ...
        public IValue Y
        {
            ...
            set
            {
                ...
                {
                    Base_obj.M_ColorPicker.Y = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_ColorPicker.Y = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue X
        {
            ...
            set
            {
                if (Utils.IsType<TfPos>(value))
                {
                    Base_obj.M_ColorPicker.X = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_ColorPicker.X = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue SuperView
        {
            get
            {
                if (Base_obj.M_ColorPicker.SuperView.GetType().ToString().Contains("+ContentView"))
                {
                    return Utils.RevertEqualsObj(Base_obj.M_ColorPicker.SuperView.SuperView).dll_obj;
                }
                return Utils.RevertEqualsObj(Base_obj.M_ColorPicker.SuperView).dll_obj;
            }
        }
        ...
        [ContextProperty("ПриИзмененииЦвета", "ColorChanged")]
        public TfAction ColorChanged { get; set; }
