...
namespace ostgui
{
    ...
    [ContextClass("ТфПереключатель", "TfRadioGroup")]
    public class TfRadioGroup : AutoContext<TfRadioGroup>
    {
        ...
        [ContextProperty("ГоризонтальноеПространство", "HorizontalSpace")]
        public int HorizontalSpace
        {
            get { return Base_obj.HorizontalSpace; }
            set { Base_obj.HorizontalSpace = value; }
        }
        ...
        public IValue Y
        {
            ...
            set
            {
                ...
                {
                    Base_obj.M_RadioGroup.Y = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_RadioGroup.Y = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue X
        {
            ...
            set
            {
                if (Utils.IsType<TfPos>(value))
                {
                    Base_obj.M_RadioGroup.X = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_RadioGroup.X = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue SuperView
        {
            get
            {
                if (Base_obj.M_RadioGroup.SuperView.GetType().ToString().Contains("+ContentView"))
                {
                    return Utils.RevertEqualsObj(Base_obj.M_RadioGroup.SuperView.SuperView).dll_obj;
                }
                return Utils.RevertEqualsObj(Base_obj.M_RadioGroup.SuperView).dll_obj;
            }
        }
        ...
        [ContextProperty("ПометкаИзменена", "SelectedItemChanged")]
