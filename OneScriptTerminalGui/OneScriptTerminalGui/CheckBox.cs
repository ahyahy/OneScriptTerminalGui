...
namespace ostgui
{
    ...
    [ContextClass("ТфФлажок", "TfCheckBox")]
    public class TfCheckBox : AutoContext<TfCheckBox>
    {
        ...
        public IValue Y
        {
            ...
            set
            {
                ...
                {
                    Base_obj.M_CheckBox.Y = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_CheckBox.Y = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue X
        {
            ...
            set
            {
                if (Utils.IsType<TfPos>(value))
                {
                    Base_obj.M_CheckBox.X = ((TfPos)value).Base_obj.M_Pos;
                }
                else if (Utils.IsNumber(value))
                {
                    Base_obj.M_CheckBox.X = Terminal.Gui.Pos.At(Utils.ToInt32(value));
                }
            }
        }
        ...
        public IValue SuperView
        {
            get
            {
                if (Base_obj.M_CheckBox.SuperView.GetType().ToString().Contains("+ContentView"))
                {
                    return Utils.RevertEqualsObj(Base_obj.M_CheckBox.SuperView.SuperView).dll_obj;
                }
                return Utils.RevertEqualsObj(Base_obj.M_CheckBox.SuperView).dll_obj;
            }
        }
        ...
        [ContextProperty("ПометкаИзменена", "Toggled")]
        public TfAction Toggled { get; set; }
